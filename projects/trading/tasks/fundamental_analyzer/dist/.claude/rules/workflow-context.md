...
- Behavioral specs live in `.agent/specs/{domain}/ComponentName.md`
- Each spec has YAML frontmatter (`spec_id`, `component`, `domain`, `status`) + Markdown body
- `_index.json` tracks all specs metadata
- `_registry.json` maps specs to implementation files
