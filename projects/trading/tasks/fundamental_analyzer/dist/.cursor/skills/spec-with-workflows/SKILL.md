...
When the user invokes this skill, you create or audit behavioral specs using the workflow engine. This provides gates, manifest, and trace — unlike the fast alternatives (`/spec-add-fast`, `/spec-audit-fast`).
...
**For a faster alternative** without workflow overhead: `/spec-add-fast`.
...
**For a faster alternative** without workflow overhead: `/spec-audit-fast`.
