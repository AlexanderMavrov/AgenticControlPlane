...
|----------|---------|---------|
| **Critical** | Очевидно грешен визуал | Missing rssKey `[I]`(N1), symbol count mismatch `[I]`(I1), green text `[W]`(C1) |
| **High** | Ясно видим при внимание | Knob asymmetry `[C]`(B1), displaced status `[C]`(G1), panel gap `[C]`(A3) |
