...
2. **Skill**: `/spec add ComponentName` — interactive creation with LLM assistance
3. **Chat pattern**: `[specs::ComponentName] your requirements here` — triggers the spec-write-and-implement workflow
